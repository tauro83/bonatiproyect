...
public class anularPreoperatorioBD {
	 ...
	 */
	 public List<anuPreoperatorio> getAllVacunaciones()
	    {	
		 List<anuPreoperatorio> vacunaciones = new ArrayList<anuPreoperatorio>();
	...
	* @return Lista con todos los registros de peluquería.
	*/
	 public List<anuPreoperatorio> getAllVacunacionesU(String nombreMascota)
	 {
		 	List<anuPreoperatorio> vacunaciones = new ArrayList<anuPreoperatorio>();
		 	anuPreoperatorio vacu;
	...
	* @return Lista con todos los registros de peluquería.
	*/
	 public List<anuPreoperatorio> getAllVacunacionesA()
	 {
		 	List<anuPreoperatorio> vacunaciones = new ArrayList<anuPreoperatorio>();
		 	anuPreoperatorio vacu;
