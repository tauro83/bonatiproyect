//=======================================================================
// Fecha Creaccion: 10/11/09
// AUTOR: Andrés Garrido R.
...
public class Alojamiento {
	...
	private int diasEstadia;//número de días que dura la estadía, calculado a partir
							// de la fecha de ingreso y la de salida
	private boolean eliminado;//nos dice si el servicio ha sido eliminado para su uso
							//existiendo dos motivos, o la mascota ha sido retirada de hotel,
							//o el usuario ha decidido eliminar este servicio registrado.
