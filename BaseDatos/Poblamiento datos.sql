INSERT INTO atencionpeluqueria (clienterut, mascotanombre, hora, responsable, fecha, estado, servicio) 
VALUES ('162989243', 'larry', '13:01:57', 'juann', '2010-01-23', 0, 'Peluqueria');

INSERT INTO bitacora2 (fecha, usuario, servicio, accion) VALUES ('23-01-2010', 'juan', 'Administración', 'Registra cliente: nombre apellido');
INSERT INTO bitacora2 (fecha, usuario, servicio, accion) VALUES ('23-01-2010', 'juan', 'Administración', 'Registra mascota: mascota especie: Perro');
INSERT INTO bitacora2 (fecha, usuario, servicio, accion) VALUES ('23-01-2010', 'juan ', 'Administración', 'Edita el usuario: juan nombre: Juanito apellido paterno: Juanito');
