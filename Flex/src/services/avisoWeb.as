...
package services
{
	 ...
	 * @autor Nicolas Delgado
	 */
	public class avisoWeb extends RemoteObject
	{
		public function avisoWeb()
		{
			super();
			...
			this.destination="avisoWeb1";
			this.source="Administracion.avisoWeb1";
		...
		{
			Alert.show("Error en avisoWeb, Detalle: "+event.fault.message);
		}
		...
		* es cambiado a 2.
		*/ 
		public function anular(estado:int):void
		{
		...
		* es cambiado 1.
		*/  
		public function eliminar(estado:int):void
		{
		...
		* es cambiado 0.
		*/  
		public function deseliminar(estado:int):void
		{
